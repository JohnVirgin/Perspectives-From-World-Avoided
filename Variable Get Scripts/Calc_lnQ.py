...
RCP45_Q_FDec_ln = np.log(RCP45_Q_FDec)
RCP45_Q_SDec_ln = np.log(RCP45_Q_SDec)

RCP45_dlnQ = RCP45_Q_SDec_ln - RCP45_Q_FDec_ln
...
wAVD_Q_FDec_ln = np.log(wAVD_Q_FDec)
wAVD_Q_SDec_ln = np.log(wAVD_Q_SDec)

wAVD_dlnQ = wAVD_Q_SDec_ln - wAVD_Q_FDec_ln

RCP45_Delta_Q_file = open("RCP45_dlnQ.pickle",'wb')
pickle.dump(RCP45_dlnQ,RCP45_Delta_Q_file)
RCP45_Delta_Q_file.close()

wAVD_Delta_Q_file = open("wAVD_dlnQ.pickle",'wb')
pickle.dump(wAVD_dlnQ,wAVD_Delta_Q_file)
