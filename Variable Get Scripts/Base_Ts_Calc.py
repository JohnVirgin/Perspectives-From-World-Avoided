...
RCP45_AT_FDec = np.zeros([5,12,96,144])
...
wAVD_AT_FDec = np.zeros([5,12,96,144])

for i in range(len(Sims)):
    wAVD_AT_FDec[i,:,:,:] = np.stack(wAVD_AT_1DA[i,:])


RCP45_AT_FDec_file = open("RCP45_Ts_2006-2015.pickle",'wb')
pickle.dump(RCP45_AT_FDec,RCP45_AT_FDec_file)
RCP45_AT_FDec_file.close()

wAVD_AT_FDec_file = open("wAVD_Ts_2006-2015.pickle",'wb')
